      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
            Ready to <span className="text-primary-glow">Transform</span> Your Sales?
          </h2>
          
          {/* Subheading */}
          <p className="text-xl text-white/80 mb-8 max-w-2xl mx-auto">
            Join thousands of sales teams already using Bastille to automate their pipeline 
            and close more deals with AI.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            ...
            <Button variant="outline" size="xl" className="bg-white/10 border-white/20 text-white hover:bg-white hover:text-foreground">
              Start Free Trial
            </Button>
          </div>
